...
if [ "$FORCE_FLAG" != "--force" ]; then
  ...
  echo "It will install Docker, enable rootless Docker, grant privileged"
  echo "port binding to rootless Docker, resize the main disk, and rebuild"
  echo "the firewall rules."
  echo
